...
df = pd.read_csv('C:\\Users\\leven\\Erasmus\\3_quartile\\LDSW\\Project\\linked_data_project\\data_files\\used\\most_popular_with_imdb.csv', low_memory=False)
...
data_props = [SCHEMA.category, SCHEMA.position, SCHEMA.interactionCount, SCHEMA.inLanguage]
